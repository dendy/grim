...
public:
	...
	BrowserModel( MainWindow * mainWindow );

	QModelIndex firstIndex( const QModelIndex & index ) const;
...
private:
	int _toParentColumn( int column ) const;
	int _fromParentColumn( int column ) const;
